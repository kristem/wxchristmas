...
function getApi(key){
    var apis = {};
    apis['POST-POINT'] = 'http://localhost:8080/game/end';//每死一次就保存分数数据地址
    apis['GET-RANK'] = 'http://localhost:8080/game/rank';//获得排行榜数据和个人排名
    apis['USER-INFO'] = 'http://localhost:8080/game/start';//每次开始游戏获取用户数据
    apis['SHARE'] = '';//这个不填
